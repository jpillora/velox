  ...
  Velox.prototype = {
    ...
    retry: function() {
      ...
      events.forEach(function(e) {
        _this.ws["on"+e] = _this["ws"+e].bind(_this);
      });
    ...
    wsmessage: function(event) {
      ...
      if(!update.Data || !this.obj) {
        this.onerror("null objects");
        return;
      }
      //perform update
      if(update.Delta)
        jsonpatch.apply(this.obj, update.Data);
      else
        merge(this.obj, update.Data);
      //auto-angular
